...
INSERT INTO `__new_quotations`("id", "number", "deadline", "credit", "include_igv", "customer_id", "validity_days", "observations", "standard_terms", "payment_codition", "is_payment_pending", "items", "created_at", "updated_at") SELECT "id", "number", "deadline", "credit", "include_igv", "customer_id", "validity_days", "observations", "standard_terms", "payment_codition", "is_payment_pending", "items", "created_at", "updated_at" FROM `quotations`;--> statement-breakpoint
